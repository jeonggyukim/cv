...
\item \textit{Modeling UV Radiative Feedback from Massive Stars: III. Escape
    ...
    J.-G.}, Kim, W.-T., \& Ostriker, E. C. 2019, \textit{ApJ accepted}
...
\begin{enumerate}
\item[] \textit{Diffuse Ionized Gas in TIGRESS Simulations of the ISM}\\
  Kado-Fong, E., \textbf{Kim, J.-G.}, Kim, C.-G., \& Ostriker, E. C.
  \textit{2019, to be submitted}
...
\item[] \textit{TIGRESS-RT: Implementation New Heating/Cooling Module with
    Adaptive Ray Tracing}\\ \textbf{Kim, J.-G.}, Gong, M., Kim, C.-G., \&
  Ostriker, E. C.
\end{enumerate}
